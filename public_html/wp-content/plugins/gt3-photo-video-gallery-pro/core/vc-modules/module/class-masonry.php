...
class Masonry extends Basic {
	protected $SHORTCODE = 'gt3pg_masonry';
	...
	public function map(){
		...
		return array(
			'name'        => esc_html__('Masonry', 'gt3pg_pro'),
			"category"    => esc_html__('GT3 Galleries', 'gt3pg_pro'),
			'description' => esc_html__('Masonry', 'gt3pg_pro'),
			'base'        => $this->SHORTCODE,
...
//						'edit_field_class' => 'vc_col-sm-6',
				...
				array(
					"type"             => "dropdown",
					"heading"          => esc_html__('Horizontal Order', 'gt3pg_pro'),
					"param_name"       => "horizontalOrder",
					'std'              => 'default',
					"group"            => esc_html__("Settings", 'gt3pg_pro'),
					"value"            => array(
						esc_html__('Default', 'gt3pg_pro')  => 'default',
