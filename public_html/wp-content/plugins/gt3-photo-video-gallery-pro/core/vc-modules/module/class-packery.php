...
class Packery extends Basic {
	...
	protected $SHORTCODE  = 'gt3pg_packery';
	...
	public function map(){
		...
		return array(
			'name'        => esc_html__('Packery', 'gt3pg_pro'),
			"category"    => esc_html__('GT3 Galleries', 'gt3pg_pro'),
			'description' => esc_html__('Packery', 'gt3pg_pro'),
			'base'        => $this->SHORTCODE,
			...
			'params'      => array(
				...
				array(
					"type"       => "dropdown",
					"heading"    => esc_html__('Packery Grid', 'gt3pg_pro'),
					"param_name" => "packery",
					'std'        => 'default',
					"group"      => esc_html__("Settings", 'gt3pg_pro'),
					"value"      => array(
						esc_html__('Default', 'gt3pg_pro') => 'default',
						esc_html__('Type 1', 'gt3pg_pro')  => '1',
						esc_html__('Type 2', 'gt3pg_pro')  => '2',
						esc_html__('Type 3', 'gt3pg_pro')  => '3',
						esc_html__('Type 4', 'gt3pg_pro')  => '4',
					),
				),
				array(
					"type"             => "dropdown",
