...
// Don't duplicate me!
if ( !class_exists( 'GT3_Radium_Theme_Demo_Data_Importer' ) ) {

	require_once dirname( __FILE__ ) .'/importer/radium-importer.php'; //load admin theme data importer

	class GT3_Radium_Theme_Demo_Data_Importer extends GT3_Radium_Theme_Importer {
		 ...
		 * @since 0.0.1
		 */
		public function __construct( $parent, $redux_instance, $part ) {
			$this->parent      = $parent;
