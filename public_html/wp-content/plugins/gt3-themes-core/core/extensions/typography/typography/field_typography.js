...
(function( $ ) {
    ...
    redux.field_objects.typography.select = function( selector, skipCheck ) {
        ...
        var all_styles = $( '#' + mainID + ' select.redux-typography-all-styles' ).val();
        var all_styles_active = $( '#' + mainID + ' select.redux-typography-all-styles' ).val();
        ...
        if ( !$( '#' + mainID ).hasClass( 'typography-initialized' ) ) {
            ...
            all_styles = $( '#' + mainID + ' select.redux-typography-all-styles' ).data( 'value' );
            all_styles_active = $( '#' + mainID + ' select.redux-typography-all-styles' ).data( 'value' );
            ...
            if ( all_styles !== "" ) {
                all_styles = String( all_styles );
            }

            if ( all_styles_active !== "" ) {
                all_styles_active = String( all_styles_active );
            }
        ...
        if ( $( selector ).hasClass( 'redux-typography-family' ) ) {
            ...
            if ( google === true ) {
                ...
                // STYLES
                var selected = "";
                var all_styles_selected = "";
                var all_styles_PartsOfString = "";
                if (all_styles !== 'undefined' && typeof all_styles !== 'undefined' && all_styles !== null) {
                    if (typeof all_styles === 'object') {
                        all_styles_PartsOfString = all_styles;
                    }else{
                        all_styles_PartsOfString = all_styles.split(',');
                    }
                }else{
                    all_styles_PartsOfString = "";
                }
                ...
                $.each(
                    details.variants, function( index, variant ) {
                        ...
                        if (all_styles !== 'undefined' && typeof all_styles !== 'undefined' && typeof all_styles_PartsOfString !== 'null' &&  all_styles_PartsOfString.indexOf(variant.id) != -1) {
                            all_styles_selected = " selected";
                            if (all_styles_active.length) {
                                all_styles_active += ',';
                            }
                            all_styles_active += variant.id;
                        }else{
                            all_styles_selected = "";
                        }
                        ...
                        font_variants += '<option value="' + variant.id + '"'+all_styles_selected+'>' + variant.name.replace(
                                /\+/g, " "
                            ) + '</option>';
                    }
                );
                ...
                var all_styles_default_params = default_params;
                $( '#' + mainID + ' .typography-all-styles .redux-typography-all-styles' ).select2( "destroy" );
                $( '#' + mainID + ' .typography-all-styles .redux-typography-all-styles' ).html( font_variants );
                $( '#' + mainID + ' .redux-typography-all-styles' ).select2( default_params );
                ...
                if ( details ) {
                    $.each(
                        details, function( index, value ) {
                            ...
                            if ((typeof all_styles !== 'undefined') && (typeof all_styles_PartsOfString !== 'undefined') && all_styles_PartsOfString.indexOf(index) != -1) {
                                all_styles_selected = " selected";
                                if (all_styles_active.length) {
                                    all_styles_active += ',';
                                }
                                all_styles_active += value;
                            }else{
                                all_styles_selected = "";
                            }
                            ...
                            if (all_styles_selected.length) {
                                font_variants += '<option value="' + index + '"'+all_styles_selected+'>' + value.replace(
                                    /\+/g, " "
                                ) + '</option>';
                            }
            ...
            if ( google === true ) {
                ...
                if ( isSelecting === false ) {
                    if ( typeof (WebFont) !== "undefined" && WebFont ) {
                        if (details.custom_font != true) {
                            WebFont.load( {google: {families: [link]}} );
                        }else{
                            if (details.custom_font_info.path.length) {
                                jQuery('head').append('<link rel="stylesheet" href="'+document.location.origin+'/wp-content/uploads/fonts/'+details.custom_font_info.path+'/font.css">');
                            }
                        }
                    }
                }
        ...
        //$( '#' + mainID + ' .typography-font-all-weight' ).val( all_styles );
        $( '#' + mainID + ' .typography-font-all-weight' ).val( all_styles_active );
