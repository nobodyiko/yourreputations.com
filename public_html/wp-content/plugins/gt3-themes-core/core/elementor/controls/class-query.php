		...
		<div class="elementor-control-field">
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-field-description"><?php printf(
						'%s <a href="https://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">%s</a>.',
						esc_html__('Select how to sort retrieved posts. More at', 'gt3_themes_core'),
						esc_html__('WordPress codex page', 'gt3_themes_core')
					) ?></div>
			</div>
		</div>
