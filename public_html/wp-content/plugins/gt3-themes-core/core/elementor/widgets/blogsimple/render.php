                            ...
                            <div class="blog_content">';
								...
								if(!empty($settings['post_btn_link'])) {
                                	...
                                	echo '<div class="gt3_blogsimple_header">';
	                                	...
	                                	$featured_image = !empty($featured_image_url) ? '<div class="gt3_blogsimple_featured_image"><a href="'. esc_url($permalink) .'"><img src="'.$featured_image_url.'" alt="'.esc_attr($post_title).'" /></a></div>' : '';
