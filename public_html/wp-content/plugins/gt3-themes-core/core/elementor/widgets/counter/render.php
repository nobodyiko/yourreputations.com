...
?>
	<div <?php $widget->print_render_attribute_string('wrapper') ?>>
		...
		$counter_info = '<div class="counter_text">
<div class="counter"></div>
<div class="hidden_end">'.$settings['prefix'].number_format($settings['end'], $settings['decimal'], $settings['decimal_point'], $settings['separator']).$suffix.'</div>
