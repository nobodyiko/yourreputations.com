...
<Script>
	...
	jQuery(function() {
		...
		jQuery( "#button-size-slider" ).slider("value",<?php if($sahu_so_design['sahu_headline_ft_size']!=""){ echo  esc_attr($sahu_so_design['sahu_headline_ft_size']); } else { echo "18"; }?>  );
...
<Script>
	...
	jQuery( "#button-size-slider3" ).slider("value",<?php if($sahu_so_design['sahu_desc_ft_size']!=""){ echo esc_attr($sahu_so_design['sahu_desc_ft_size']); } else { echo "16"; }?> );
	jQuery( "#sahu_desc_ft_size" ).val( jQuery( "#button-size-slider3" ).slider( "value") );
		...
		<table class="form-table">
			...
			<tr class="radio-span" >
				<td>						
					<input id="sahu_so_bg_clr" name="sahu_so_bg_clr" type="text" value="<?php echo esc_attr($sahu_so_design['sahu_so_bg_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
			...
			<tr class="radio-span" >
				<td>						
						...
						<input type="hidden" id="sahu_so_bg_img" name="sahu_so_bg_img" class="rcsp_label_text"  value="<?php echo esc_attr($sahu_so_design['sahu_so_bg_img']); ?>"  readonly="readonly" placeholder="No Media Selected" />
			...
			<tr class="radio-span" >
				<td>						
					<input id="sahu_headeline_ft_clr" name="sahu_headeline_ft_clr" type="text" value="<?php echo esc_attr($sahu_so_design['sahu_headeline_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
			...
			<tr class="radio-span" >
				<td>						
					<input id="sahu_desc_ft_clr" name="sahu_desc_ft_clr" type="text" value="<?php echo esc_attr($sahu_so_design['sahu_desc_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
			...
			<tr class="radio-span" >
				<td>
					...
					<input id="sahu_cnt_ft_clr" name="sahu_cnt_ft_clr" type="text" value="<?php echo esc_attr($sahu_so_design['sahu_cnt_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
			...
			<tr class="radio-span" >
				<td>
					...
					<input id="sahu_social_clr" name="sahu_social_clr" type="text" value="<?php echo esc_attr($sahu_so_design['sahu_social_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<tr>
			...
			<tr class="radio-span" >
				<td>
						<textarea rows="6"  class="pro_text" id="sahu_so_custom_css" name="sahu_so_custom_css" placeholder="<?php _e('Enter Your custom CSS Here',''); ?>"><?php echo esc_textarea(stripslashes($sahu_so_design['sahu_so_custom_css'])); ?></textarea>
